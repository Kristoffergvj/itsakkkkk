   ...
   public class Input
    {
        ...
        public static void Set(string clientfile, string serverfile, string prop, string genPass, string pwd)
        {
            try
            {
                ...
                Dictionary<string, string> decryptVaultDict = Kryptering.DecryptVault(clientfile, serverfile, pwd);
        ...
        static void Create(string clientFile, string serverFile, string masterpwd, string secretkey)
        {
            ...
            try
            {
                ...
                decryptvaultDict = Kryptering.DecryptVault(clientFile, serverFile, masterpwd);
                ...
                string decryptVaultString = JsonSerializer.Serialize(decryptvaultDict);
                string encvaultContent = Kryptering.EncryptVault(decryptVaultString,clientFile,serverFile,masterpwd);
        ...
        static void Get(string clientfile, string serverfile, string prop, string masterpassword)
        {
            ...
            decryptedVaultdict = Kryptering.DecryptVault(clientfile, serverfile, masterpassword);

            // skriver ut hela vaultet okrypterat för att se om allt är med
            Console.WriteLine(decryptedVaultdict);
        ...
        static void Delete (string clientfile, string serverfile, string prop, string masterpassword)
        {
            ...
            {
                // Deserialize the encrypted vault to a dictionary
                Dictionary<string, string> decryptVaultDict = Kryptering.DecryptVault(clientfile, serverfile, masterpassword);
                //Dictionary<string, string> decryptVaultDict = JsonSerializer.Deserialize<Dictionary<string, string>>(Kryptering.DecryptVault(clientfile, serverfile, pwd));
